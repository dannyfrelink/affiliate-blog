					...
					>
						...
						>
							...
							<BaseText>
								...
								maanden samen op reis geweest en we voelde
								allebei dat we dit veel te leuk vonden. Sinds
								2018 hebben wij dan ook meerdere reizen gemaakt
								en in 2022 hebben we zelfs vijf maanden op Bali
								gewoond. We zijn dan ook allebei een beetje
								verliefd geworden op Indonesië en komen hier
								graag terug.
							</BaseText>
							<BaseText>
								Geregeld krijgen we vragen over onze reizen en
								we vinden het dan ook geweldig om hierover te
							...
							{screenSize >= 1250 && (
								<div className="[&>p:not(:last-of-type)]:mb-4">
									<BaseText>
										...
										‘reis’ erin, wat doelt op onze
										reisverhalen. Daarnaast kan je dit woord
										op zijn Engels uitspreken, waardoor
										‘rice field’ ontstaat. Dit verwijst naar
										de prachtige rijstvelden op Bali. Als
										laatste staat het woord ‘feel’ erin. Dit
										is de Engelse vertaling van ‘gevoel’ en
										verwijst naar ons gevoel van geluk als
										wij aan het reizen zijn. Een naam met
										veel betekenis dus.
									</BaseText>
									<BaseText>
										Met onze tips en ervaringen hopen wij
										jouw voorbereidingen én reis een stukje
										leuker te maken!
									</BaseText>
								</div>
							)}
						...
						{screenSize < 1250 && (
							...
							>
								<BaseText>
									...
									waardoor ‘Ricefield’ ontstaat. Dit verwijst
